...
const CELL_COLORS = [
  ...
  THEME_COLORS.MAGENTA, THEME_COLORS.PURPLE,  THEME_COLORS.BLUE,    THEME_COLORS.ORANGE,  THEME_COLORS.YELLOW,  THEME_COLORS.MAGENTA, // 13-18
  THEME_COLORS.ORANGE,  THEME_COLORS.BLUE,    THEME_COLORS.YELLOW,  THEME_COLORS.PURPLE,  THEME_COLORS.YELLOW,  THEME_COLORS.LIME,    // 19-24
  THEME_COLORS.BLUE,    THEME_COLORS.RED,     THEME_COLORS.BLUE,    THEME_COLORS.PURPLE,  THEME_COLORS.MAGENTA, THEME_COLORS.LIME,    // 25-30
  THEME_COLORS.PURPLE,  THEME_COLORS.RED,     THEME_COLORS.LIME,    THEME_COLORS.ORANGE,  THEME_COLORS.YELLOW,  THEME_COLORS.MAGENTA  // 31-36
];
